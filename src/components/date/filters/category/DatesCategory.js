        ...
        <div className="w-full bg-gradient-to-t from-blue-300 to-blue-400">
          ...
          <div>
            <h2 className="text-white text-3xl mt-4 font-bold text-center ">
              Filtra tus citas por una categoria
            </h2>
            <form className="w-full  p-4 md:p-6 items-center">
              <div className="mb-4 ">
                ...
                <select
                  ...
                  type="text"
                  id="category"
                  className="shadow appearance-none border rounded  mx-auto w-full md:py-2 p-4 mt-2 md:mt-0 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-400 focus:bg-gray-50 focus:shadow-outline"
                >
          ...
          {alert && alertMsg && !spinner && (
            <div className="py-20 md:py-0 mx-auto w-1/2 md:w-full">
          ...
          {spinner && (
            <div className="flex justify-center py-20 md:py-0 ">
              <Spinner />
            </div>
          )}
